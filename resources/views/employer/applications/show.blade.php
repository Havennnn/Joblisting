                            ...
                            <div class="p-6">
                                ...
                                <form action="{{ route('employer.applications.update-status', $application->id) }}"
                                    ...
                                    <div class="mt-6 flex items-center justify-between">
                                        ...
                                        <button type="submit"
                                            onclick="document.getElementById('status').value = 'rejected'; document.getElementById('action').value = 'reject';"
                                        ...
                                        @if($application->status === 'to be interviewed' && $application->interview_status === 'accepted')
                                        <button type="submit"
                                            onclick="document.getElementById('status').value = 'accepted'; document.getElementById('action').value = 'accept';"
                                        ...
                                        @if($application->status !== 'accepted' && $application->status !== 'to be interviewed')

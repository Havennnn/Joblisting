                                ...
                                <div>
                                    ...
                                    <div class="mt-1 flex items-center">
                                        <span class="inline-block h-12 w-12 rounded-full overflow-hidden bg-gray-100">
                                            ...
                                            @elseif(Auth::user()->applicantProfile && Auth::user()->applicantProfile->profile_picture_path)
                                                <img src="{{ route('applicant.profile.picture', ['user' => Auth::id()]) }}" alt="Profile" class="h-full w-full object-cover">
                                            @else

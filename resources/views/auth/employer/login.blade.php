                ...
                <div class="bg-white py-8 px-4 shadow-lg sm:px-10">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="mt-6 grid grid-cols-2 gap-3">
                            <a href="{{ route('google.login', ['user_type' => 'employer']) }}" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
                            ...
                            <a href="{{ route('facebook.login', ['user_type' => 'employer']) }}" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">

                        ...
                        <div class="bg-gray-50 rounded-lg p-6 mb-6">
                            <div class="flex items-start">
                                <div class="flex-shrink-0 mr-4">
                                    @if($JobPost->company && $JobPost->company->logo_path)
                                        <img src="{{ asset('storage/' . $JobPost->company->logo_path) }}" alt="Company Logo" class="h-16 w-16 rounded-lg object-cover">
                                    @else
                                ...
                                <div>
                                    <h3 class="text-lg font-medium text-gray-900">
                                        ...
                                        @else
                                            {{ $JobPost->employer->company_name ?? 'Company Name Not Available' }}
                                        @endif
                                    </h3>
                                    <p class="mt-1 text-sm text-gray-600">
                                        @if($JobPost->company)
                                            {{ $JobPost->company->industry }}
                                        @else
                                            {{ $JobPost->employer->industry ?? 'Industry Not Available' }}
                                        @endif
                                    </p>
                                    <p class="mt-1 text-sm text-gray-600">
                                        @if($JobPost->company)
                                            {{ $JobPost->company->location }}
                                        @else
                                            {{ $JobPost->employer->location ?? 'Location Not Available' }}
                                        @endif
                                    </p>
                                    @if($JobPost->company && $JobPost->company->website)
                                        <a href="{{ $JobPost->company->website }}" target="_blank" class="mt-2 text-sm text-blue-600 hover:text-blue-800 inline-flex items-center">
                                    ...
                                    @elseif($JobPost->employer && $JobPost->employer->website)

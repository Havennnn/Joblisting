    ...
    <div class="max-w-md w-full p-6 bg-white rounded-lg shadow-md">
        ...
        <form method="POST" action="{{ route('password.update.otp') }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="otp" name="otp" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-neksjob-blue focus:border-neksjob-blue" required autofocus>
            ...
            <div class="mb-4">
                ...
                <input type="password" id="password" name="password" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-neksjob-blue focus:border-neksjob-blue" required>
            </div>

            <div class="mb-6">
                <label for="password_confirmation" class="block text-gray-700 text-sm font-medium mb-2">Confirm New Password</label>
                <input type="password" id="password_confirmation" name="password_confirmation" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-neksjob-blue focus:border-neksjob-blue" required>
            </div>

            <div class="mb-6">
                <button type="submit" class="w-full bg-neksjob-blue text-white py-2 px-4 rounded-md hover:bg-blue-600 transition duration-300">
                    Reset Password
                </button>
            </div>
            ...
            <div class="text-center text-sm text-gray-600">
                <p>
                    ...
                    <form method="POST" action="{{ route('applicant.password.email') }}" class="inline">
                        @csrf
                        <input type="hidden" name="email" value="{{ $email }}">
                        <button type="submit" class="text-neksjob-blue hover:underline">Resend</button>
                    </form>
                </p>
            </div>
        </form>

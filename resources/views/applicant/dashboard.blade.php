                    ...
                    <div class="bg-white overflow-hidden shadow rounded-lg">
                        <div class="px-4 py-5 sm:p-6">
                            <dl>
                                ...
                                <dd class="mt-3">
                                    <span class="text-sm text-blue-600 hover:text-blue-500">
                                        <a href="{{ $profileCompletionPercentage < 100 ? ($user->setup_completed ? route('applicant.profile') : route('applicant.setup')) : route('applicant.profile') }}" class="flex items-center">
                                            {{ $profileCompletionPercentage < 100 ? ($user->setup_completed ? 'Enhance your profile' : 'Complete your profile') : 'View your profile' }}
                                            <svg class="ml-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
                                            </svg>
                                        </a>

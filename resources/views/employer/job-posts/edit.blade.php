    ...
    <div class="flex-1 ml-4">
        <div class="bg-white rounded-lg shadow-sm p-6">
            <div class="flex items-center justify-between mb-6">
                <h1 class="text-2xl font-bold text-gray-900">Edit Job: {{ $jobPost->title }}</h1>
                <a href="{{ route('employer.JobPost') }}" class="text-neksjob-blue hover:text-neksjob-blue-dark">
                    Back to Jobs
                </a>
            </div>
            ...
            <div class="bg-gray-50 rounded-lg border border-gray-200 mb-6 p-4">
                ...
                <div class="mb-4">
                    <div class="flex items-center justify-between mb-1">
                        <span class="text-sm font-medium text-gray-700">{{ $completionPercentage ?? 0 }}% Complete</span>
                        <a href="{{ route('employer.profile.edit') }}" class="text-sm text-neksjob-blue hover:underline">Complete Profile</a>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2.5">
                        <div class="bg-neksjob-blue h-2.5 rounded-full" style="width: {{ $completionPercentage ?? 0 }}%"></div>
                    </div>
                </div>

...
<div class="flex justify-center items-center min-h-screen py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-md">
        ...
        <form class="mt-2 space-y-2" action="{{ route('employer.register') }}" method="POST">
            @csrf
            ...
            <div class="rounded-md space-y-2">
                ...
                <div>
                    ...
                    <textarea id="company_description" name="company_description" rows="3" required
                        class="appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-pink-500 focus:border-pink-500 focus:z-10 sm:text-sm">{{ old('company_description') }}</textarea>
            ...
            <div class="space-y-3">
                <button type="button"
                    class="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500">

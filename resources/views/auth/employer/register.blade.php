        ...
        <div class="max-w-md w-full bg-white shadow-lg p-8">
            ...
            <div class="mt-6">
                ...
                <div class="mt-6 grid grid-cols-2 gap-3">
                    <a href="{{ route('google.login', ['user_type' => 'employer']) }}" class="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
                    ...
                    <a href="{{ route('facebook.login', ['user_type' => 'employer']) }}" class="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">

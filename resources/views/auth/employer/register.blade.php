        ...
        <div class="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
            ...
            <div class="mt-6">
                ...
                <div class="mt-6 grid grid-cols-2 gap-3">
                    <a href="{{ route('google.login', ['user_type' => 'employer']) }}" class="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
                    ...
                    <a href="{{ route('facebook.login', ['user_type' => 'employer']) }}" class="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
            ...
            <p class="mt-8 text-center text-sm text-gray-600">
                ...
                <a href="{{ route('employer.login') }}" class="font-medium text-[#2563EB] hover:text-blue-600">
                    Sign in
                </a>
            </p>
        </div>

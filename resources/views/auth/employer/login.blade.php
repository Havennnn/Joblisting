...
<div class="flex flex-col items-center justify-center min-h-screen bg-white py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full">
        <h2 class="text-center text-3xl font-semibold text-neksjob-blue mb-6">
            Employers Sign in
        </h2>

        <form class="mt-8 space-y-6" action="{{ route('employer.login.post') }}" method="POST">
            @csrf
            ...
            <div>
                <a href="{{ route('employer.password.request') }}" class="text-sm text-[#DC2626] hover:underline">
                    Forgot Password?
                </a>
            </div>
            ...
            <div class="grid gap-3">
                <a href="{{ route('google.login', ['user_type' => 'employer']) }}" class="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                ...
                <a href="{{ route('facebook.login', ['user_type' => 'employer']) }}" class="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
        ...
        <div class="my-6 text-center">
            <p class="text-sm text-gray-600">Don't have an account? <a href="{{ route('employer.register') }}" class="font-medium text-[#DC2626] hover:underline">Register</a></p>
        </div>
    </div>
</div>
@endsection

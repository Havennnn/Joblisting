...
<div class="min-h-screen bg-[#EBF5FF] py-12 px-4 sm:px-6 lg:px-8 relative">
    ...
    <div class="flex flex-col items-center justify-center relative z-10">
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-[#2563EB]">Create an account before applying</h1>
        </div>
        ...
        <div class="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
            ...
            <p class="mt-8 text-center text-sm text-gray-600">
                ...
                <a href="{{ route('applicant.login') }}" class="font-medium text-[#2563EB] hover:text-blue-600">
                    Sign in
                </a>
            </p>
        </div>

...
<div class="flex flex-col items-center justify-center min-h-screen bg-white py-12 px-4 sm:px-6 lg:px-8">
    <h1 class="text-3xl font-medium text-gray-900 mb-8">Create an account before applying</h1>
    ...
    <div class="max-w-md w-full bg-white rounded-lg border border-gray-200 shadow-sm p-8">
        ...
        <form id="applicant-registration-form" class="space-y-6" action="{{ route('applicant.register.post') }}" method="POST">
            @csrf
        ...
        <div class="mt-6">
            ...
            <div class="mt-6 space-y-3">
                <a href="{{ route('facebook.login', ['user_type' => 'applicant']) }}" class="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                ...
                <a href="{{ route('google.login', ['user_type' => 'applicant']) }}" class="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
        ...
        <p class="mt-8 text-center text-sm text-gray-600">
            ...
            <a href="{{ route('applicant.login') }}" class="font-medium text-[#2271b1] hover:text-[#135e96]">
                Sign in
            </a>
        </p>
    </div>

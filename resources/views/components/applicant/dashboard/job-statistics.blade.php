...
<div class="bg-white shadow-sm overflow-hidden">
    <div class="p-5 border-b border-gray-200">
        <h2 class="text-lg font-semibold">Job statistics</h2>
    ...
    <div class="p-5">
        <div class="h-60">
            ...
            <div class="h-full relative">
                ...
                <div class="absolute inset-0 flex items-end justify-between pt-6">
                    ...
                    <div class="w-1/7 flex flex-col items-center">
                        <div class="space-y-1 w-12">
                            <div class="h-32 bg-yellow-400 w-full"></div>
                            <div class="h-14 bg-indigo-600 w-full"></div>
                        </div>
                    ...
                    <div class="w-1/7 flex flex-col items-center">
                        <div class="space-y-1 w-12">
                            <div class="h-12 bg-yellow-400 w-full"></div>
        ...
        <div class="mt-6 flex items-center justify-center space-x-8">
            <div class="flex items-center">
                ...
                <span class="text-xs text-gray-600">Job View</span>
            </div>
            <div class="flex items-center">
                <div class="w-3 h-3 bg-indigo-600 mr-2"></div>
                <span class="text-xs text-gray-600">Job Applied</span>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 border-t border-gray-200">
        <div class="p-5 border-r border-gray-200">
            <div class="flex items-center">
                <div class="flex-1">
                    <h3 class="text-sm text-gray-500 uppercase">Job Views</h3>
                    <div class="flex items-baseline mt-1">
                        <span class="text-2xl font-bold">2,342</span>
        ...
        <div class="p-5">
            <div class="flex items-center">
                <div class="flex-1">
                    <h3 class="text-sm text-gray-500 uppercase">Job Applied</h3>
                    <div class="flex items-baseline mt-1">
                        <span class="text-2xl font-bold">654</span>

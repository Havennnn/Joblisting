                ...
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        ...
                        <p class="mt-1 text-sm text-gray-600">
                            This information will be displayed to employers looking for candidates.
                        </p>
                    </div>
                </div>
                        ...
                        <div class="shadow sm:rounded-md sm:overflow-hidden">
                            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="name" id="name" value="{{ $user->name }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    @error('name')
                                ...
                                <div>
                                    ...
                                    <input type="text" name="headline" id="headline" value="{{ $user->headline ?? '' }}" placeholder="e.g. Frontend Developer with 3 years of experience" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                </div>

                                <div>
                                    <label for="bio" class="block text-sm font-medium text-gray-700">Bio</label>
                                    <div class="mt-1">
                                        <textarea id="bio" name="bio" rows="3" class="shadow-sm focus:ring-blue-500 focus:border-blue-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="Tell employers a bit about yourself">{{ $user->bio ?? '' }}</textarea>
                                    </div>
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <input type="text" name="skills" id="skills" value="{{ $user->skills ?? '' }}" placeholder="e.g. HTML, CSS, JavaScript, PHP, Laravel" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>
            ...
            <div class="mt-10 md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        ...
                        <p class="mt-1 text-sm text-gray-600">
                            Upload your resume to apply for jobs more easily.
                        </p>
                    </div>
                </div>
                <div class="mt-5 md:mt-0 md:col-span-2">

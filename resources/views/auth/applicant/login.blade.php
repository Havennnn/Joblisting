                ...
                <div class="bg-white py-8 px-4 shadow-lg sm:px-10">
                    <form class="space-y-6" action="{{ route('applicant.login.post') }}" method="POST">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div>
                                <a href="{{ route('applicant.password.request') }}" class="text-sm text-[#2563EB] hover:underline">
                                    Forgot Password?
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="mt-6 text-center">
                        <p class="text-sm text-gray-600">Don't have an account? <a href="{{ route('applicant.register') }}" class="font-medium text-[#2563EB] hover:underline">Register</a></p>
                    </div>
                </div>
            </div>
        </div>

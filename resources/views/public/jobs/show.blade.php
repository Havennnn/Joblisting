            ...
            @auth
                @if(auth()->user()->isApplicant())
                    @php
                        ...
                        $completionService = new \App\Services\Dashboard\ProfileCompletionService();
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="mt-2 text-sm text-yellow-700">
                                        <p>You need to complete your profile before applying for jobs.</p>
                                        <div class="mt-3">
                                            <div class="mb-1 flex items-center justify-between">
                                                <span class="text-xs font-medium">{{ $completionPercentage }}% Complete</span>
                                            </div>
                                            <div class="w-full bg-gray-200 rounded-full h-2">
                                                <div class="bg-neksjob-blue h-2 rounded-full" style="width: {{ $completionPercentage }}%"></div>
                                            </div>
                                        </div>
                                        <div class="mt-4">
                                            <a href="{{ route('applicant.profile.edit') }}" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-neksjob-blue hover:bg-neksjob-blue-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neksjob-blue">

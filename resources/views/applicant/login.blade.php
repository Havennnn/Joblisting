...
<div class="flex flex-col items-center justify-center min-h-screen bg-white py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full">
        <h2 class="text-center text-3xl font-semibold text-[#2271b1] mb-6">
            Jobseekers Sign in
        </h2>

        <form class="mt-8 space-y-6" action="{{ route('applicant.login.post') }}" method="POST">
            @csrf
            ...
            <div>
                <a href="{{ route('password.request') }}" class="text-sm text-[#2271b1] hover:underline">
                    Forgot Password?
                </a>
            </div>
            ...
            <div class="grid gap-3">
                <a href="{{ route('google.login', ['user_type' => 'applicant']) }}" class="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                ...
                <a href="{{ route('facebook.login', ['user_type' => 'applicant']) }}" class="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
